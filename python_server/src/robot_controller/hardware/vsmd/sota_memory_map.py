...
MASTER_CONTROL_PERIOD_ADDRESS = 0x0040
...
INTERP_LED_REMAINING_TIME_BASE = 0x0D80
INTERP_LED_REMAINING_TIME_LENGTH = 16
...
SOTA_MOUTH_REMAINING_TIME_ADDRESS = calculate_indexed_address(
    INTERP_LED_REMAINING_TIME_BASE, SOTA_MOUTH_GLOBAL_LED_ID, 2
)
